...
\begin{enumerate}
    \item First two paragraphs can be removed. Done
    \item I do not think dask is a WMF, recalling L1-L4, no strong preference, but you need to be consistent, as you go on to say about "dask" "data intensive tasks via data parallel frameworks"
    \item Remove basic definitions to the end. You can assume your committee knows what a MakeSpan is.
    \item Proposed Topic --> Questions 
    \item (multiple) repeats of "context" and "definitions" on pg 7. Campaign and manager definitions are repeated a lot
    \item Distinction between HETF for workflows and Campaigns. How is campaign different from workflows and there is already a problem statement. Use the space to talk about solution.
    ...
    \item More technical in the solution side of things. At least one paragraph for each objective based on timeline.
\end{enumerate}}
