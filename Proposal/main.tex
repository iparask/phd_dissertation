...
the workflow, and a desired deadline for completion. The resource manage based 
...
tasks to decide the resource, the concurrency and timeline of the execution of 
...
of an autonomic system. Figure~\ref{fig:architecture} shows a simple diagram of the 
