%Scientific application workflows properties, such as size, and requirements, 
%such as type and number of resources, change in time. In scientific campaign 
%These properties of the workflow are not necessarily captured during the  
%specification of the workload.  bla bla workload manager autonomic IBM~\cite
%{ibm2005autonomic}
