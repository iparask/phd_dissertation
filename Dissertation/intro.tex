...
environment. There is therefore a need for abstractions \mtnote{what is a
computing environment and how does it differ from an HPC environment, and how
does it `support' a framework?} that support frameworks like Hadoop and Spark
