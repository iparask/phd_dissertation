...
These campaigns usually have hundreds of workflows as members and can be executed on different platforms, such as workstations, campus and HPC clusters, based on workflow requirements.
...
In Chapter~\ref{sec:task-par}, we investigate three task-parallel frameworks and their suitability for implementing MD trajectory analysis algorithms.
