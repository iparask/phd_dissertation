...
\begin{inparaenum}[1)]
    ...
    \item define and enact upon a plan that will achieve the computation objective of the campaign; and
...
The goal of this research is to advance the state of the art in the execution of scientific computational campaigns.
...
We eveluate the integration by measuring and characterizing the startup times of the Pilot and the tasks.
