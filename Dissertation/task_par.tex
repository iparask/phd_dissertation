...
We investigate the data analysis requirements of Molecular Dynamics (MD) applications.
...
Performing analysis quickly and efficiently, so as to steer simulations, remains still challenge since different task-parallel frameworks offer different capabilities.
As a result, there is a need to understand which framework is more suited for performing a specific analysis.
...
The chapter is organized as follows: Section~\ref{sec:md_use_cases} discusses the MD analysis algorithms investigated and reviews different MD analysis frameworks with respect to their ability to support scalable analytics of large volume MD trajectories. 
...
The chapter concludes with a conceptual framework that allows application developers to carefully select a framework according to their requirements, in  section~\ref{sec:task_sel_model}.
%
