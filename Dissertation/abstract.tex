Scientific applications, with constant streams of data or simulations, are benefiting from executing computational campaigns, instead of executing a single workflow.
