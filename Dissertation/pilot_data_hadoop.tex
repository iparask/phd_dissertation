...
%High Performance Computing (HPC) and Hadoop originated from the need to support different kinds of applications: compute-intensive applications in the case of HPC, and data-intensive in the case of Hadoop.
...
%These include principal component based analysis~\cite{doi:10.1021/ct400341p}, as well as graph-based algorithms~\cite{mdanalysis}.
