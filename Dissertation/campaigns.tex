...
\begin{figure*}[ht!]
    \centering
    \includegraphics[width=.99\textwidth]{figures/plan_comp.pdf}
...
\begin{figure*}[ht!]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=.95\textwidth]{figures/StHomoCampaigns_4StHomoResources.pdf}
        \caption{}
        \label{fig:StHomoCampaigns_4StHomoResources}
    \end{subfigure}%
    ~ 
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\linewidth]{figures/StHomoResources_StHomoCampaigns.pdf}
        \caption{}
...
\begin{figure*}[ht!]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=.95\textwidth]{figures/StHeteroCampaigns_4StHeteroResources.pdf}
        \caption{}
        \label{fig:StHeteroCampaigns_4StHeteroResources}
    \end{subfigure}%
    ~ 
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\linewidth]{figures/StHeteroResources_StHeteroCampaigns.pdf}
        \caption{}
...
- Analysis of heterogeneous/heterogeneous cases:
I do not expect siginificant differences between planners.
...
L2FF will provide a makepsan that fluctuates significantly between different cases.
Finally, the random planner will show erratic behavior, depending on the run.

\subsection{Resource availability}

Explore how HEFT and GA behave for different resource initial availability.

\subsection{Time to calculate a plan}
