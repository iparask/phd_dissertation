...
Requirements describe the minimum amount and type of resources needed to execute each workflow of the campaign, while the constrains are the conditions that bound the execution, such as resource availability, resource capacity or costs.
...
Sensitivity to makespan runtime uncertainty has a wide range of values for HEFT and L2FF, but significantly smaller range for GA-50 and random.
