...
\S~\ref{ssec:kmeans}, we showed that the RP-YARN reduces the time to completion 
of a data-intensive workflow. Thus, the Pilot-Abstraction increases HPC resources 
